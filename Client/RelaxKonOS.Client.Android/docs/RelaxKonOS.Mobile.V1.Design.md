...
上述限制针对本 V1 范围。后续“只有手机也能部署”的扩展见 [无电脑部署路线图](./RelaxKonOS.Mobile.Deployment.Roadmap.md)：其中 Git、轻量编辑、证书与网络发布有独立实施计划，按阶段交付，不因建立文档就纳入 V1 已实现功能。认证、凭据、自适应和能力门控继续遵守本文及对应专属设计。
