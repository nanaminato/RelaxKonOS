...
public sealed class FileServicesApp : RemoteApplicationBase
{
    ...
    public override void Activate(AppContext context)
    {
        ...
        root.Children.Add(new TextBlock { Text = T("file_services.users", "Linux Samba users") }); var userActions = new StackPanel { Orientation = Orientation.Horizontal, Spacing = 8 }; userActions.Children.Add(new Button { Content = T("file_services.user_toggle", "Enable / disable"), Command = vm.ToggleUserCommand }); userActions.Children.Add(new Button { Content = T("file_services.user_password", "Set Samba password"), Command = vm.SetSambaPasswordCommand }); root.Children.Add(userActions);
