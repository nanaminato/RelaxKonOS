...
- 事件与告警中心（部署、证书、Guardian、Docker、隧道）：[Goal](docs/applications/RelaxKonOS.EventAlertCenter.Goal.md)。
...
7. 拖动文件夹/文件到桌面
   ...
   2	新增“事件与告警中心”	汇总部署失败、证书续期、Guardian 崩溃、Docker 异常、隧道断开等，并提供审计、跳转与处理入口（[Goal](docs/applications/RelaxKonOS.EventAlertCenter.Goal.md)）
...
新增“事件与告警中心” 汇总部署失败、证书续期、Guardian 崩溃、Docker 异常、隧道断开等，并提供审计、跳转与处理入口。见 [Goal](docs/applications/RelaxKonOS.EventAlertCenter.Goal.md)。
