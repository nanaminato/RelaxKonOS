...
- 当前开发机已有 Android SDK API 37、Build Tools 36.0.0、本地 Gradle 9.7.1 压缩包及 .NET Android workload。其默认 JDK 为 25，而该 workload 要求 JDK 21；Android APK 构建等待批准的本地 JDK 21。
...
待 JDK 21 准备完毕后，依次执行 `Tools/Mobile/Build-Android.ps1 -JavaSdkRoot <JDK-21 根目录>`、安装 APK、手机/平板旋转与网络切换验证。
