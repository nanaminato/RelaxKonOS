...
| --- | --- | --- | --- | --- | --- |
| I01 | M1 | Protocol、路由、严格 DTO、问题码 | 已实现待验证 | T01 | `Shared/RelaxKonOS.Protocol/ApplicationDeployments/`（6 文件：路由、契约、操作契约、枚举、问题码、请求）；请求 DTO 全部 `JsonUnmappedMemberHandling.Disallow`。待 T01 |
