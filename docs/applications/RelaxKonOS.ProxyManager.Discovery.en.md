...
- Since 2026-09-01, Windows no longer creates a second SCM service: `RelaxKonOS.Server` owns Mihomo through `WindowsMihomoProcessHost`; Linux continues to use `remoteos-mihomo.service`.
