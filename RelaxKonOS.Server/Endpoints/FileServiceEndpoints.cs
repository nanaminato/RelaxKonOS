...
public static class FileServiceEndpoints
{
    ...
    public static IEndpointRouteBuilder MapFileServiceEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapPost(FileServiceApiRoutes.Install, (HttpContext context, IHostElevationSessionStore elevations, IFileServiceAudit audit, IFileServiceManager manager, CancellationToken ct) => RunAsync(context, elevations, audit, "install", ElevationTarget, () => manager.InstallAsync(ct))).RequireAuthorization("FileServicesManage");
        group.MapPost(FileServiceApiRoutes.Start, (HttpContext context, IHostElevationSessionStore elevations, IFileServiceAudit audit, IFileServiceManager manager, CancellationToken ct) => RunAsync(context, elevations, audit, "start", ElevationTarget, () => manager.LifecycleAsync(SmbLifecycleAction.Start, ct))).RequireAuthorization("FileServicesManage");
        group.MapPost(FileServiceApiRoutes.Stop, (HttpContext context, IHostElevationSessionStore elevations, IFileServiceAudit audit, IFileServiceManager manager, CancellationToken ct) => RunAsync(context, elevations, audit, "stop", ElevationTarget, () => manager.LifecycleAsync(SmbLifecycleAction.Stop, ct))).RequireAuthorization("FileServicesManage");
        group.MapPost(FileServiceApiRoutes.Restart, (HttpContext context, IHostElevationSessionStore elevations, IFileServiceAudit audit, IFileServiceManager manager, CancellationToken ct) => RunAsync(context, elevations, audit, "restart", ElevationTarget, () => manager.LifecycleAsync(SmbLifecycleAction.Restart, ct))).RequireAuthorization("FileServicesManage");
        group.MapPost(FileServiceApiRoutes.Shares, (UpsertFileShareRequest request, HttpContext context, IHostElevationSessionStore elevations, IFileServiceAudit audit, IFileServiceManager manager, CancellationToken ct) => RunAsync(context, elevations, audit, "share-create", request.Path, () => manager.CreateShareAsync(request, ct))).RequireAuthorization("FileServicesManage");
        group.MapPut(FileServiceApiRoutes.ShareById, (string shareId, UpsertFileShareRequest request, HttpContext context, IHostElevationSessionStore elevations, IFileServiceAudit audit, IFileServiceManager manager, CancellationToken ct) => RunAsync(context, elevations, audit, "share-update", shareId, () => manager.UpdateShareAsync(shareId, request, ct))).RequireAuthorization("FileServicesManage");
        group.MapDelete(FileServiceApiRoutes.ShareById, (string shareId, HttpContext context, IHostElevationSessionStore elevations, IFileServiceAudit audit, IFileServiceManager manager, CancellationToken ct) => RunAsync(context, elevations, audit, "share-delete", shareId, () => manager.DeleteShareAsync(shareId, ct))).RequireAuthorization("FileServicesManage");
        ...
        if (OperatingSystem.IsLinux())
        {
            ...
            group.MapPost(FileServiceApiRoutes.EnableUser, (string username, HttpContext context, IHostElevationSessionStore elevations, IFileServiceAudit audit, IFileServiceManager manager, CancellationToken ct) => RunAsync(context, elevations, audit, "user-enable", username, () => manager.SetUserEnabledAsync(username, true, ct))).RequireAuthorization("FileServicesManage");
            group.MapPost(FileServiceApiRoutes.DisableUser, (string username, HttpContext context, IHostElevationSessionStore elevations, IFileServiceAudit audit, IFileServiceManager manager, CancellationToken ct) => RunAsync(context, elevations, audit, "user-disable", username, () => manager.SetUserEnabledAsync(username, false, ct))).RequireAuthorization("FileServicesManage");
            group.MapPut(FileServiceApiRoutes.UserPassword, (string username, SetSambaPasswordRequest request, HttpContext context, IHostElevationSessionStore elevations, IFileServiceAudit audit, IFileServiceManager manager, CancellationToken ct) => RunAsync(context, elevations, audit, "user-password", username, () => manager.SetUserPasswordAsync(username, request.Password, ct))).RequireAuthorization("FileServicesManage");
        }
        return app;
    }
